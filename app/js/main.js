...
var ElixirModel = _backbone2['default'].Model.extend({
...
exports["default"] = ElixirTemplate;
module.exports = exports["default"];
...
var _elixirModel = require('./elixir.model');

var _elixirModel2 = _interopRequireDefault(_elixirModel);

var ElixirsCollection = _backbone2['default'].Collection.extend({
  url: 'https://api.parse.com/1/classes/BackboneAssign18',

  model: _elixirModel2['default'],
...
exports['default'] = ElixirsCollection;
module.exports = exports['default'];

},{"./elixir.model":1,"backbone":5}],4:[function(require,module,exports){
'use strict';
...
var _elixirsCollection = require('./elixirs.collection');

var _elixirsCollection2 = _interopRequireDefault(_elixirsCollection);

var _elixirTemplate = require('./elixir.template');

var _elixirTemplate2 = _interopRequireDefault(_elixirTemplate);

var APP_ID = 'JUHEvllrCLEVNH0Y6Lui2IEghbNgLZsEx0OF4wHk';

var API_KEY = '66UDIAncFf7BN2XCR1dTh7P120X1HXPHXrc1oUGe';
...
var elixirs = new _elixirsCollection2['default']();
...
function renderElixirs() {
  ...
  elixirs.each(function (elixir) {
    ...
    var data = elixir.toJSON();

    var templateString = (0, _elixirTemplate2['default'])(data);
...
},{"./elixir.template":2,"./elixirs.collection":3,"jquery":6,"moment":7,"underscore":8}],5:[function(require,module,exports){
(function (global){
//     Backbone.js 1.2.3
